...
Context-only enrichment. This module does NOT change the v0.7.7 STRICT gates,
...
def _notes() -> list[str]:
    return [
        "Flow context is informational only and does not change v0.7.7 STRICT gates or trade decisions.",
