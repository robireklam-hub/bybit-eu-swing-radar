"""Initialize the Swing Radar PostgreSQL schema.

Run on Railway as a pre-deploy command:
    python init_db.py
"""
...
SCHEMA_SQL = r"""CREATE TABLE IF NOT EXISTS instruments (
...
async def main() -> None:
    ...
    try:
        ...
        print("Swing Radar database schema initialized successfully.")
