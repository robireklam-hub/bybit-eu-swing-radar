...
app = FastAPI(
    ...
    version="0.7.7",
    description="Read-only cached USDC swing/day scanner; day-trade strategy v0.7.7 with persistent confirmed-breakout recommendation state and context-only derivatives Flow feature v0.7.2.2.",
)
